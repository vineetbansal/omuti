...
from omuti.torch import IoU
from omuti.torch.utilities import check_file
from omuti.torch import visualize


def evaluate_image(predictions, ground_df, savedir=None):
    """
    ...
    if savedir:
        image = np.array(Image.open(plot_name))[:, :, ::-1]
